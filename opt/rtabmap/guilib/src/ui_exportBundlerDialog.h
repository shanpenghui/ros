...
public:
    ...
    {
        ExportBundlerDialog->setWindowTitle(QApplication::translate("ExportBundlerDialog", "Export Bundler", 0, QApplication::UnicodeUTF8));
        groupBox->setTitle(QApplication::translate("ExportBundlerDialog", "Motion Blur Filtering", 0, QApplication::UnicodeUTF8));
        label_40->setText(QApplication::translate("ExportBundlerDialog", "These optional parameters can be used to avoid exporting blurred images. 0 means not used.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_laplacianVariance->setSuffix(QString());
        label_38->setText(QApplication::translate("ExportBundlerDialog", "Laplacian variance threshold. Below this threshold, the image is considered blurred. 50 can be good default.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_linearSpeed->setSuffix(QApplication::translate("ExportBundlerDialog", " m/s", 0, QApplication::UnicodeUTF8));
        label_39->setText(QApplication::translate("ExportBundlerDialog", "Maximum linear speed. Images taken on fast motions would be more blurry. 0.1 m/s can be good default.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_angularSpeed->setSuffix(QApplication::translate("ExportBundlerDialog", " rad/s", 0, QApplication::UnicodeUTF8));
        label_41->setText(QApplication::translate("ExportBundlerDialog", "Maximum angular speed. Images taken on fast motions would be more blurry. 0.4 rad/s can be good default.", 0, QApplication::UnicodeUTF8));
        groupBox_export_points->setTitle(QApplication::translate("ExportBundlerDialog", "Export 3D Points", 0, QApplication::UnicodeUTF8));
        label_8->setText(QApplication::translate("ExportBundlerDialog", "SBA Iterations", 0, QApplication::UnicodeUTF8));
        label_variance->setText(QApplication::translate("ExportBundlerDialog", "SBA Pixel variance used by g2o.", 0, QApplication::UnicodeUTF8));
        sba_variance->setSuffix(QString());
        label_10->setText(QApplication::translate("ExportBundlerDialog", "SBA Type", 0, QApplication::UnicodeUTF8));
        comboBox_sbaType->clear();
        comboBox_sbaType->insertItems(0, QStringList()
         << QApplication::translate("ExportBundlerDialog", "g2o", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportBundlerDialog", "cvsba", 0, QApplication::UnicodeUTF8)
        );
        label_variance_2->setText(QApplication::translate("ExportBundlerDialog", "Rematch features.", 0, QApplication::UnicodeUTF8));
        sba_rematchFeatures->setText(QString());
        label_42->setText(QApplication::translate("ExportBundlerDialog", "Output folder:", 0, QApplication::UnicodeUTF8));
        toolButton_path->setText(QApplication::translate("ExportBundlerDialog", "...", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
