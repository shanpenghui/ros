...
public:
    ...
    void retranslateUi(QDialog *calibrationDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        label_22->setToolTip(QApplication::translate("calibrationDialog", "If > 1, image is scaled down to help board detection on high definition images", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_22->setText(QApplication::translate("calibrationDialog", "Max scale", 0, QApplication::UnicodeUTF8));
        groupBox_progress->setTitle(QApplication::translate("calibrationDialog", "Progress", 0, QApplication::UnicodeUTF8));
        ...
        checkBox_fisheye->setText(QApplication::translate("calibrationDialog", "Fish eye", 0, QApplication::UnicodeUTF8));
