...
public:
    ...
    {
        DepthCalibrationDialog->setWindowTitle(QApplication::translate("DepthCalibrationDialog", "Depth Calibration", 0, QApplication::UnicodeUTF8));
        label_111->setText(QApplication::translate("DepthCalibrationDialog", "<html><head/><body><p>CLAMS approach is used for depth calibration. Please visit <a href=\"http://www.alexteichman.com/octo/clams/\"><span style=\" text-decoration: underline; color:#0000ff;\">CLAMS website</span></a> for tips about how to get a good map for depth calibration. If you want to process multiple mapping sessions, uncheck &quot;Reset previous model&quot;. If logger's level is debug, 3D map and generated depth images will be shown during the calibration.</p></body></html>", 0, QApplication::UnicodeUTF8));
        groupBox_2->setTitle(QApplication::translate("DepthCalibrationDialog", "Map generation", 0, QApplication::UnicodeUTF8));
        checkBox_laserScan->setText(QString());
        label_110->setText(QApplication::translate("DepthCalibrationDialog", "Use 3D laser scans for 3D map.", 0, QApplication::UnicodeUTF8));
        label_108->setText(QApplication::translate("DepthCalibrationDialog", "Decimation (1-2-4-8-...).", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_maxDepth->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", 0, QApplication::UnicodeUTF8));
        label_132->setText(QApplication::translate("DepthCalibrationDialog", "Maximum depth (0 means no limit).", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_minDepth->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", 0, QApplication::UnicodeUTF8));
        label_133->setText(QApplication::translate("DepthCalibrationDialog", "Minimum depth.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_voxelSize->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", 0, QApplication::UnicodeUTF8));
        label_voxel->setText(QApplication::translate("DepthCalibrationDialog", "Voxel size. Set 0 to disable.", 0, QApplication::UnicodeUTF8));
        groupBox->setTitle(QApplication::translate("DepthCalibrationDialog", "Distortion Model", 0, QApplication::UnicodeUTF8));
        spinBox_bin_width->setSuffix(QApplication::translate("DepthCalibrationDialog", " pix", 0, QApplication::UnicodeUTF8));
        label_113->setText(QApplication::translate("DepthCalibrationDialog", "Bin width. Should be a multiple of image width.", 0, QApplication::UnicodeUTF8));
        label_117->setText(QApplication::translate("DepthCalibrationDialog", "Bin depth.", 0, QApplication::UnicodeUTF8));
        label_120->setText(QApplication::translate("DepthCalibrationDialog", "Image height.", 0, QApplication::UnicodeUTF8));
        label_116->setText(QApplication::translate("DepthCalibrationDialog", "Bin height. Should be a multiple of image height.", 0, QApplication::UnicodeUTF8));
        spinBox_bin_height->setSuffix(QApplication::translate("DepthCalibrationDialog", " pix", 0, QApplication::UnicodeUTF8));
        label_118->setText(QApplication::translate("DepthCalibrationDialog", "Maximum depth.", 0, QApplication::UnicodeUTF8));
        label_115->setText(QApplication::translate("DepthCalibrationDialog", "Smoothing.", 0, QApplication::UnicodeUTF8));
        label_119->setText(QApplication::translate("DepthCalibrationDialog", "Image width.", 0, QApplication::UnicodeUTF8));
        label_width->setText(QApplication::translate("DepthCalibrationDialog", "NA", 0, QApplication::UnicodeUTF8));
        label_height->setText(QApplication::translate("DepthCalibrationDialog", "NA", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_bin_depth->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_maxDepthModel->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_coneRadius->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_coneStdDevThresh->setSuffix(QApplication::translate("DepthCalibrationDialog", " m", 0, QApplication::UnicodeUTF8));
        label_voxel_2->setText(QApplication::translate("DepthCalibrationDialog", "Cone radius.", 0, QApplication::UnicodeUTF8));
        label_voxel_3->setText(QApplication::translate("DepthCalibrationDialog", "Cone standard deviation threshold.", 0, QApplication::UnicodeUTF8));
        label_109->setText(QApplication::translate("DepthCalibrationDialog", "Reset previous model.", 0, QApplication::UnicodeUTF8));
        checkBox_resetModel->setText(QString());
        label_112->setText(QApplication::translate("DepthCalibrationDialog", "Current model:", 0, QApplication::UnicodeUTF8));
        label_trainingSamples->setText(QApplication::translate("DepthCalibrationDialog", "0", 0, QApplication::UnicodeUTF8));
        label_114->setText(QApplication::translate("DepthCalibrationDialog", "training samples", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
