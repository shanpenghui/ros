...
static const char qt_meta_stringdata_rtabmap__EditDepthArea[] = {
    "rtabmap::EditDepthArea\0\0resetChanges()\0"
};
...
const QMetaObjectExtraData rtabmap::EditDepthArea::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rtabmap::EditDepthArea::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rtabmap__EditDepthArea,
      qt_meta_data_rtabmap__EditDepthArea, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rtabmap::EditDepthArea::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rtabmap__EditDepthArea))
