...
static const char qt_meta_stringdata_rtabmap__RecoveryState[] = {
    "rtabmap::RecoveryState\0\0cancel()\0"
};
...
const QMetaObjectExtraData rtabmap::RecoveryState::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rtabmap::RecoveryState::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rtabmap__RecoveryState,
      qt_meta_data_rtabmap__RecoveryState, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rtabmap::RecoveryState::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rtabmap__RecoveryState))
