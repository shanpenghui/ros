...
public:
    ...
    void setupUi(QMainWindow *mainWindow)
    {
        ...
        actionRealSense2_D435->setObjectName(QString::fromUtf8("actionRealSense2_D435"));
        actionRealSense2_D435->setCheckable(true);
        actionRealSense2_D415 = new QAction(mainWindow);
        actionRealSense2_D415->setObjectName(QString::fromUtf8("actionRealSense2_D415"));
        ...
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/images/d435.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        menuRealSense_D435->setIcon(icon17);
        menuRealSense_D415 = new QMenu(menuRGB_D_camera);
        menuRealSense_D415->setObjectName(QString::fromUtf8("menuRealSense_D415"));
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/images/d415.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuRealSense_D415->setIcon(icon19);
        menuStereo_camera = new QMenu(menuSelect_source);
        menuStereo_camera->setObjectName(QString::fromUtf8("menuStereo_camera"));
        QIcon icon20;
        icon20.addFile(QString::fromUtf8(":/images/bumblebee2.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuStereo_camera->setIcon(icon20);
        menuBumblebee2_2 = new QMenu(menuStereo_camera);
        menuBumblebee2_2->setObjectName(QString::fromUtf8("menuBumblebee2_2"));
        menuBumblebee2_2->setIcon(icon20);
        menuZed_camera = new QMenu(menuStereo_camera);
        menuZed_camera->setObjectName(QString::fromUtf8("menuZed_camera"));
        QIcon icon21;
        icon21.addFile(QString::fromUtf8(":/images/zed.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuZed_camera->setIcon(icon21);
    ...
    void retranslateUi(QMainWindow *mainWindow)
    {
        ...
        actionView_high_res_point_cloud->setText(QApplication::translate("mainWindow", "View point clouds...", 0, QApplication::UnicodeUTF8));
        ...
        actionStereoZed->setText(QApplication::translate("mainWindow", "Zed sdk", 0, QApplication::UnicodeUTF8));
        actionStereoUsb->setText(QApplication::translate("mainWindow", "Stereo Usb Camera", 0, QApplication::UnicodeUTF8));
        actionExport_octomap->setText(QApplication::translate("mainWindow", "Export octomap...", 0, QApplication::UnicodeUTF8));
        actionRealSense_R200->setText(QApplication::translate("mainWindow", "RealSense", 0, QApplication::UnicodeUTF8));
        actionDepth_Calibration->setText(QApplication::translate("mainWindow", "Depth calibration...", 0, QApplication::UnicodeUTF8));
        actionRealSense_ZR300->setText(QApplication::translate("mainWindow", "RealSense", 0, QApplication::UnicodeUTF8));
        actionKinect_for_Windows_SDK_v2->setText(QApplication::translate("mainWindow", "Kinect for Windows SDK v2", 0, QApplication::UnicodeUTF8));
        actionRealSense2_D435->setText(QApplication::translate("mainWindow", "RealSense2", 0, QApplication::UnicodeUTF8));
        actionRealSense2_D415->setText(QApplication::translate("mainWindow", "RealSense2", 0, QApplication::UnicodeUTF8));
        ...
        menuRealSense_R200->setTitle(QApplication::translate("mainWindow", "RealSense R200", 0, QApplication::UnicodeUTF8));
        menuRealSense_ZR300->setTitle(QApplication::translate("mainWindow", "RealSense ZR300", 0, QApplication::UnicodeUTF8));
        menuRealSense_D435->setTitle(QApplication::translate("mainWindow", "RealSense D435", 0, QApplication::UnicodeUTF8));
        menuRealSense_D415->setTitle(QApplication::translate("mainWindow", "RealSense D415", 0, QApplication::UnicodeUTF8));
        ...
        menuZed_camera->setTitle(QApplication::translate("mainWindow", "Zed camera", 0, QApplication::UnicodeUTF8));
