...
public:
    ...
    void setupUi(QDialog *ExportCloudsDialog)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -1112, 773, 4339));
        ...
        gridLayout_8->addWidget(checkBox_regenerate, 9, 0, 1, 1);
        ...
        gridLayout_8->addWidget(checkBox_filtering, 10, 0, 1, 1);
        ...
        gridLayout_8->addWidget(label_regenerate, 9, 1, 1, 1);
        ...
        gridLayout_8->addWidget(checkBox_gainCompensation, 12, 0, 1, 1);
        ...
        gridLayout_8->addWidget(label_gainCompensation, 12, 1, 1, 1);
        ...
        spinBox_normalKSearch->setMinimum(3);
        ...
        gridLayout_8->addWidget(label_binaryFile_12, 13, 1, 1, 1);
        ...
        gridLayout_8->addWidget(checkBox_smoothing, 11, 0, 1, 1);
        ...
        gridLayout_8->addWidget(label_smoothing, 11, 1, 1, 1);
        ...
        gridLayout_15->addWidget(spinBox_textureBrightnessContrastRatioHigh, 12, 0, 1, 1);
        ...
        gridLayout_15->addWidget(label_meshingTextureSize_6, 12, 1, 1, 1);
        ...
        gridLayout_15->addWidget(comboBox_blendingDecimation, 10, 0, 1, 1);
        ...
        gridLayout_15->addWidget(checkBox_blending, 9, 0, 1, 1);
        ...
        gridLayout_15->addWidget(label_exposureFusion_3, 10, 1, 1, 1);
        ...
        gridLayout_15->addWidget(label_exposureFusion_2, 9, 1, 1, 1);
        ...
        gridLayout_15->addWidget(label_meshingTextureSize_5, 11, 1, 1, 1);
        ...
        gridLayout_15->addWidget(checkBox_exposureFusion, 14, 0, 1, 1);
        ...
        gridLayout_15->addWidget(checkBox_cameraFilter, 8, 0, 1, 1);
        ...
        gridLayout_15->addWidget(spinBox_textureBrightnessContrastRatioLow, 11, 0, 1, 1);
        ...
        gridLayout_15->addWidget(label_meshingTextureSize_3, 8, 1, 1, 1);
        ...
        gridLayout_15->addWidget(label_exposureFusion, 14, 1, 1, 1);
    ...
    void retranslateUi(QDialog *ExportCloudsDialog)
    {
        ...
        label_regenerate->setText(QApplication::translate("ExportCloudsDialog", "Regenerate clouds. This can be used to regenerate the point clouds at higher density than those used for online visualization.", 0, QApplication::UnicodeUTF8));
        ...
        label_gainCompensation->setText(QApplication::translate("ExportCloudsDialog", "Gain compensation. Normalize brightness of images.", 0, QApplication::UnicodeUTF8));
        label_frame->setText(QApplication::translate("ExportCloudsDialog", "Output frame.", 0, QApplication::UnicodeUTF8));
        label_binaryFile_12->setText(QApplication::translate("ExportCloudsDialog", "Meshing.", 0, QApplication::UnicodeUTF8));
        checkBox_smoothing->setText(QString());
        label_binaryFile_9->setText(QApplication::translate("ExportCloudsDialog", "Cloud filtering. Remove sparse points that are far from surfaces.", 0, QApplication::UnicodeUTF8));
        checkBox_meshing->setText(QString());
        label_binaryFile->setText(QApplication::translate("ExportCloudsDialog", "Binary file (for ply and pcd outputs).", 0, QApplication::UnicodeUTF8));
        label_smoothing->setText(QApplication::translate("ExportCloudsDialog", "Cloud smoothing using Moving Least Squares algorithm (MLS).", 0, QApplication::UnicodeUTF8));
        ...
        comboBox_frame->insertItems(0, QStringList()
         << QApplication::translate("ExportCloudsDialog", "Map", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "Robot", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "Camera", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "Scan", 0, QApplication::UnicodeUTF8)
        );
        checkBox_binary->setText(QString());
        label_binaryFile_11->setText(QApplication::translate("ExportCloudsDialog", "From RGB-D images. If not checked, clouds will be generated from laser scans.", 0, QApplication::UnicodeUTF8));
        checkBox_fromDepth->setText(QString());
        label_normal_2->setText(QApplication::translate("ExportCloudsDialog", "Set the search radius for the normal estimation.", 0, QApplication::UnicodeUTF8));
        groupBox_regenerateScans->setTitle(QApplication::translate("ExportCloudsDialog", "Regenerate clouds", 0, QApplication::UnicodeUTF8));
        label_109->setText(QApplication::translate("ExportCloudsDialog", "Downsampling step.", 0, QApplication::UnicodeUTF8));
        groupBox_regenerate->setTitle(QApplication::translate("ExportCloudsDialog", "Regenerate Clouds", 0, QApplication::UnicodeUTF8));
        toolButton_distortionModel->setText(QApplication::translate("ExportCloudsDialog", "...", 0, QApplication::UnicodeUTF8));
        spinBox_fillDepthHoles->setSuffix(QApplication::translate("ExportCloudsDialog", " pixels", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_minDepth->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_108->setText(QApplication::translate("ExportCloudsDialog", "3D cloud decimation (1-2-4-8-...). Negative decimation is done from RGB size instead of depth size (if depth is smaller than RGB, it may be interpolated depending of the decimation value).", 0, QApplication::UnicodeUTF8));
        spinBox_fillDepthHolesError->setSuffix(QApplication::translate("ExportCloudsDialog", " %", 0, QApplication::UnicodeUTF8));
        ...
        label_197->setText(QApplication::translate("ExportCloudsDialog", "Fill depth hole size (0 means no fill).", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_maxDepth->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_134->setText(QApplication::translate("ExportCloudsDialog", "Path to a depth distortion model to apply (output from depth calibration).", 0, QApplication::UnicodeUTF8));
        label_198->setText(QApplication::translate("ExportCloudsDialog", "Fill depth hole error.", 0, QApplication::UnicodeUTF8));
        label_135->setText(QApplication::translate("ExportCloudsDialog", "ROI ratios [left, right, top, bottom] between 0 and 1. Only generate 3D points for pixels inside the region of interest (RGB image).", 0, QApplication::UnicodeUTF8));
        checkBox_bilateral->setText(QString());
        label_136->setText(QApplication::translate("ExportCloudsDialog", "Bilateral filtering of the depth image. Reduce noise in depth images.", 0, QApplication::UnicodeUTF8));
        label_137->setText(QApplication::translate("ExportCloudsDialog", "Cloud subtraction. Superposed points from different nodes are filtered.", 0, QApplication::UnicodeUTF8));
        checkBox_subtraction->setText(QString());
        groupBox_bilateral->setTitle(QApplication::translate("ExportCloudsDialog", "Bilateral Filtering of the Depth Image", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_bilateral_sigmaR->setSuffix(QString());
        label_194->setText(QApplication::translate("ExportCloudsDialog", "Standard deviation of the Gaussian for the intensity difference. Set the standard deviation of the Gaussian used to control how much an adjacent pixel is downweighted because of the intensity difference (depth in our case).", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_bilateral_sigmaS->setSuffix(QString());
        label_195->setText(QApplication::translate("ExportCloudsDialog", "Size of the Gaussian bilateral filter window to use. Set the standard deviation of the Gaussian used by the bilateral filter for the spatial neighborhood/window.", 0, QApplication::UnicodeUTF8));
        ...
        groupBox_filtering->setTitle(QApplication::translate("ExportCloudsDialog", "Cloud Filtering", 0, QApplication::UnicodeUTF8));
        ...
        groupBox_mls->setTitle(QApplication::translate("ExportCloudsDialog", "Cloud Smoothing", 0, QApplication::UnicodeUTF8));
...
"Guidelines: 4 times the voxel size, 0.025 for voxel=0.", 0, QApplication::UnicodeUTF8));
        ...
        label_90->setText(QApplication::translate("ExportCloudsDialog", "Output voxel size. Used to filter superposed points after upsampling.", 0, QApplication::UnicodeUTF8));
        ...
        groupBox_gain->setTitle(QApplication::translate("ExportCloudsDialog", "Gain Compensation", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_gainBeta->setSuffix(QString());
        label_binaryFile_7->setText(QApplication::translate("ExportCloudsDialog", "Do full compensation between all locations (longer to do but quality is better). Otherwise, compensation is done only between linked locations.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_gainOverlap->setSuffix(QString());
        checkBox_gainFull->setText(QString());
        label_binaryFile_3->setText(QApplication::translate("ExportCloudsDialog", "Correspondence radius", 0, QApplication::UnicodeUTF8));
        label_binaryFile_5->setText(QApplication::translate("ExportCloudsDialog", "Beta. The lower, the higher the compensation is but images are darker. When texturing, brightness and contrast balance below can be activated to re-increase brightness (e.g., set high ratio to 20%).", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_gainRadius->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_binaryFile_6->setText(QApplication::translate("ExportCloudsDialog", "Min overlap (%)", 0, QApplication::UnicodeUTF8));
        label_binaryFile_8->setText(QApplication::translate("ExportCloudsDialog", "Gain on each RGB channel separatly.", 0, QApplication::UnicodeUTF8));
        ...
        label_meshClean->setText(QApplication::translate("ExportCloudsDialog", "Clean mesh from polygons without color or texture.", 0, QApplication::UnicodeUTF8));
        label_denseReconstruction->setText(QApplication::translate("ExportCloudsDialog", "Surface reconstruction approach. Poisson is available when clouds are assembled and dense reconstruction flavor is selected. CPU-TSDF is available when clouds are assembled, organized reconstruction flavor is selected and RTAB-Map is built with CPU-TSDF support. OpenChisel is available when clouds are assembled and RTAB-Map is built with OpenChisel support.", 0, QApplication::UnicodeUTF8));
        label_meshDecimation_2->setText(QApplication::translate("ExportCloudsDialog", "Transferring color radius. Radius used to transfer color from original cloud to resampled reconstructed surface (e.g., Poisson or mesh decimation). Negative means disabled, 0 means take the nearest point.", 0, QApplication::UnicodeUTF8));
        label_meshDecimation->setText(QApplication::translate("ExportCloudsDialog", "Mesh quadric decimation factor (0=no decimation). Used to reduce the number of polygons. Higher the factor, lower the output resolution (less polygons). Can be used when organized mesh approach is not selected. Can reduce a lot texturing time.", 0, QApplication::UnicodeUTF8));
        label_textureMapping->setText(QApplication::translate("ExportCloudsDialog", "Texture mapping. Images of the cameras will be projected on the mesh(es). Output is a *.obj format. Available on Export or when clouds are not assembled.", 0, QApplication::UnicodeUTF8));
        comboBox_meshingApproach->clear();
        comboBox_meshingApproach->insertItems(0, QStringList()
         << QApplication::translate("ExportCloudsDialog", "Fast GP3", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "Poisson", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "CPU-TSDF", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "Organized", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "Open Chisel (TSDF)", 0, QApplication::UnicodeUTF8)
        );
        checkBox_textureMapping->setText(QString());
        doubleSpinBox_transferColorRadius->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        checkBox_cleanMesh->setText(QString());
        label_16->setText(QApplication::translate("ExportCloudsDialog", "Minimum polygon cluster size (-1 means that only the biggest cluster is kept).", 0, QApplication::UnicodeUTF8));
        label_meshMaxPolygons->setText(QApplication::translate("ExportCloudsDialog", "Maximum polygons (0=no max). Another way to do mesh quadric decimation, the factor will be computed depending on the polygons generated.", 0, QApplication::UnicodeUTF8));
        spinBox_meshMaxPolygons->setSuffix(QString());
        groupBox_textureMapping->setTitle(QApplication::translate("ExportCloudsDialog", "Texturing", 0, QApplication::UnicodeUTF8));
        spinBox_textureBrightnessContrastRatioHigh->setSuffix(QApplication::translate("ExportCloudsDialog", " %", 0, QApplication::UnicodeUTF8));
        label_meshingTextureSize_6->setText(QApplication::translate("ExportCloudsDialog", "Brightness and contrast balance high ratio. Only used when textures are merged.", 0, QApplication::UnicodeUTF8));
        comboBox_blendingDecimation->clear();
        comboBox_blendingDecimation->insertItems(0, QStringList()
         << QApplication::translate("ExportCloudsDialog", "Auto", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "1", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "2", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "4", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "8", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "16", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "32", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "64", 0, QApplication::UnicodeUTF8)
        );
        checkBox_blending->setText(QString());
        label_exposureFusion_3->setText(QApplication::translate("ExportCloudsDialog", "Blending decimation. ", 0, QApplication::UnicodeUTF8));
        label_meshingTextureSize_7->setText(QApplication::translate("ExportCloudsDialog", "ROI ratios [left right top bottom] between 0 and 1. This can be used to ignore black borders of RGB images caused by calibration. ", 0, QApplication::UnicodeUTF8));
        label_meshingTextureSize_8->setText(QApplication::translate("ExportCloudsDialog", "Maximum output textures.", 0, QApplication::UnicodeUTF8));
        label_exposureFusion_2->setText(QApplication::translate("ExportCloudsDialog", "Blending. Only used with dense reconstruction flavor and if clouds are assembled.", 0, QApplication::UnicodeUTF8));
        label_meshingTextureSize_2->setText(QApplication::translate("ExportCloudsDialog", "Maximum distance from the camera for polygons to be textured by this camera (0 means infinite). Only used with dense reconstruction flavor.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_meshingTextureMaxDistance->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_meshingTextureSize_5->setText(QApplication::translate("ExportCloudsDialog", "Brightness and contrast balance low ratio. Only used when textures are merged.", 0, QApplication::UnicodeUTF8));
        label_meshingTextureFormat->setText(QApplication::translate("ExportCloudsDialog", "Texture format.", 0, QApplication::UnicodeUTF8));
        comboBox_meshingTextureFormat->clear();
        comboBox_meshingTextureFormat->insertItems(0, QStringList()
         << QApplication::translate("ExportCloudsDialog", ".jpg", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", ".png", 0, QApplication::UnicodeUTF8)
        );
        comboBox_meshingTextureSize->clear();
        comboBox_meshingTextureSize->insertItems(0, QStringList()
         << QApplication::translate("ExportCloudsDialog", "Disabled", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "256x256", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "512x512", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "1024x1024", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "2048x2048", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "4096x4096", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "8192x8192", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "16384x16384", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ExportCloudsDialog", "32768x32768", 0, QApplication::UnicodeUTF8)
        );
        checkBox_exposureFusion->setText(QString());
        label_meshingTextureSize_4->setText(QApplication::translate("ExportCloudsDialog", "Minimum polygon cluster size for texturing. This removes textures applied on sparse polygons. Only used with dense reconstruction flavor.", 0, QApplication::UnicodeUTF8));
        label_meshingTextureSize->setText(QApplication::translate("ExportCloudsDialog", "Output texture size. If not set or when clouds are not assembled, all textures are saved separately. Warning: values higher than 2048 may not be compatible with all GPUs.", 0, QApplication::UnicodeUTF8));
        checkBox_cameraFilter->setText(QString());
        spinBox_textureBrightnessContrastRatioLow->setSuffix(QApplication::translate("ExportCloudsDialog", " %", 0, QApplication::UnicodeUTF8));
        label_meshingTextureSize_3->setText(QApplication::translate("ExportCloudsDialog", "Camera filtering. Some criteria to select which cameras are used for texturing.", 0, QApplication::UnicodeUTF8));
        label_exposureFusion->setText(QApplication::translate("ExportCloudsDialog", "Exposure fusion. Only used when textures are merged and brightness/contrast balance ratios are used (merging original texture + 1 for each ratios).", 0, QApplication::UnicodeUTF8));
        label_meshingTextureSize_9->setText(QApplication::translate("ExportCloudsDialog", "Maximum depth error between reconstructed mesh projection in camera and corresponding value in depth image to apply texturing (negative means disabled, 0 means that longest edge length of the face is used as maximum error).", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_meshingTextureMaxDepthError->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_meshingTextureSize_10->setText(QApplication::translate("ExportCloudsDialog", "Maximum angle between camera and face to apply texture (0 means disabled).", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_meshingTextureMaxAngle->setSuffix(QApplication::translate("ExportCloudsDialog", " deg", 0, QApplication::UnicodeUTF8));
        groupBox_cameraFilter->setTitle(QApplication::translate("ExportCloudsDialog", "Camera Filtering", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_cameraFilterRadius->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_37->setText(QApplication::translate("ExportCloudsDialog", "Only one camera in a fixed radius and angle is used for texturing. Radius of 0 m means disabled.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_laplacianVariance->setSuffix(QString());
        doubleSpinBox_cameraFilterAngle->setSuffix(QApplication::translate("ExportCloudsDialog", " deg", 0, QApplication::UnicodeUTF8));
        label_38->setText(QApplication::translate("ExportCloudsDialog", "Laplacian variance threshold. Below this threshold, the image is considered blurred. 0 means disabled. 50 can be good default.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_cameraFilterVelRad->setSuffix(QApplication::translate("ExportCloudsDialog", " rad/s", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_cameraFilterVel->setSuffix(QApplication::translate("ExportCloudsDialog", " m/s", 0, QApplication::UnicodeUTF8));
        label_39->setText(QApplication::translate("ExportCloudsDialog", "Maximum speed to keep a camera view for texturing. Images taken on fast motions would be more blurry. 0 means disabled. 0.1 m/s and 0.4 rad/s can be good defaults.", 0, QApplication::UnicodeUTF8));
...
"Guidelines: 4 times the voxel size, 0.025 for voxel=0.", 0, QApplication::UnicodeUTF8));
        ...
        label_180->setText(QApplication::translate("ExportCloudsDialog", "Scale. Set the ratio between the diameter of the cube used for reconstruction and the diameter of the samples' bounding cube.", 0, QApplication::UnicodeUTF8));
        checkBox_poisson_outputPolygons->setText(QString());
        label_outputPolygons->setText(QApplication::translate("ExportCloudsDialog", "Output polygons flag. Enabling this flag tells the reconstructor to output a polygon mesh (rather than triangulating of the results of Marching Cubes). Disabled when exporting to file, if mesh decimation is set or when texturing.", 0, QApplication::UnicodeUTF8));
        groupBox_cputsdf->setTitle(QApplication::translate("ExportCloudsDialog", "CPU-TSDF Reconstruction", 0, QApplication::UnicodeUTF8));
        label_25->setText(QApplication::translate("ExportCloudsDialog", "<html><head/><body><p><a href=\"https://github.com/sdmiller/cpu_tsdf\"><span style=\" text-decoration: underline; color:#0000ff;\">https://github.com/sdmiller/cpu_tsdf</span></a></p></body></html>", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_cputsdf_size->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_19->setText(QApplication::translate("ExportCloudsDialog", "Volume size.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_cputsdf_resolution->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_20->setText(QApplication::translate("ExportCloudsDialog", "Resolution.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_cputsdf_tuncPos->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_21->setText(QApplication::translate("ExportCloudsDialog", "Depth truncation positive limit. Maximum distance a voxel will be set to positive.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_cputsdf_tuncNeg->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_22->setText(QApplication::translate("ExportCloudsDialog", "Depth truncation negative limit. Maximum distance a voxel will be set to negative.", 0, QApplication::UnicodeUTF8));
        spinBox_cputsdf_randomSplit->setSuffix(QString());
        label_23->setText(QApplication::translate("ExportCloudsDialog", "Set the number of random samples per surface point the octree should split on. If you don't know what this does, it's almost certainly best to leave it at 1.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_cputsdf_minWeight->setSuffix(QString());
        label_18->setText(QApplication::translate("ExportCloudsDialog", "Minimum weight of a voxel to be added in the mesh.", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_cputsdf_flattenRadius->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_24->setText(QApplication::translate("ExportCloudsDialog", "Flatten radius (0=disabled).", 0, QApplication::UnicodeUTF8));
        ...
        groupBox_openchisel->setTitle(QApplication::translate("ExportCloudsDialog", "OpenChisel Reconstruction", 0, QApplication::UnicodeUTF8));
        label_26->setText(QApplication::translate("ExportCloudsDialog", "<html><head/><body><p><a href=\"https://github.com/personalrobotics/OpenChisel\"><span style=\" text-decoration: underline; color:#0000ff;\">https://github.com/personalrobotics/OpenChisel</span></a></p><p>Parameters below match those in chisel_ros package. Voxel resolution is taken from the general voxel parameter above, it should not be null. <br/><span style=\" font-weight:600;\">Issue: </span>If voxel size or chunk size are changed after exporting/viewing one time, the app should be restarted to avoid black meshes.</p></body></html>", 0, QApplication::UnicodeUTF8));
        label_36->setText(QApplication::translate("ExportCloudsDialog", "truncation_constant", 0, QApplication::UnicodeUTF8));
        label_35->setText(QApplication::translate("ExportCloudsDialog", "chunk_size_z", 0, QApplication::UnicodeUTF8));
        label_40->setText(QApplication::translate("ExportCloudsDialog", "truncation_linear", 0, QApplication::UnicodeUTF8));
        label_43->setText(QApplication::translate("ExportCloudsDialog", "integration_weight", 0, QApplication::UnicodeUTF8));
        label_46->setText(QApplication::translate("ExportCloudsDialog", "near_plane_dist", 0, QApplication::UnicodeUTF8));
        label_34->setText(QApplication::translate("ExportCloudsDialog", "chunk_size_y", 0, QApplication::UnicodeUTF8));
        ...
        label_31->setText(QApplication::translate("ExportCloudsDialog", "chunk_size_x", 0, QApplication::UnicodeUTF8));
        label_42->setText(QApplication::translate("ExportCloudsDialog", "truncation_scale", 0, QApplication::UnicodeUTF8));
        label_41->setText(QApplication::translate("ExportCloudsDialog", "truncation_quadratic", 0, QApplication::UnicodeUTF8));
        label_44->setText(QApplication::translate("ExportCloudsDialog", "use_voxel_carving", 0, QApplication::UnicodeUTF8));
        label_45->setText(QApplication::translate("ExportCloudsDialog", "carving_dist_m", 0, QApplication::UnicodeUTF8));
        label_47->setText(QApplication::translate("ExportCloudsDialog", "far_plane_dist", 0, QApplication::UnicodeUTF8));
        ...
        doubleSpinBox_openchisel_carving_dist_m->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_openchisel_near_plane_dist->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        doubleSpinBox_openchisel_far_plane_dist->setSuffix(QApplication::translate("ExportCloudsDialog", " m", 0, QApplication::UnicodeUTF8));
        label_48->setText(QApplication::translate("ExportCloudsDialog", "Simplify generated mesh by merging close vertices together. Required for some post mesh filtering approaches to work properly.", 0, QApplication::UnicodeUTF8));
